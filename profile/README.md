...
-   사건 요약 자동 생성 및 시간 흐름 정리
-   핵심 사실 및 주장-근거 구조화
-   주요 쟁점 도출

### 3. 법령·판례 기반 RAG 분석

-   법령 및 판례 데이터 연동 (Vector DB)
-   사건 유형별 법리적 쟁점 분석을 통한 근거 기반 수사 판단 지원

### 4. 심문 및 조사 지원 기능

-   진술 내용 간 모순 탐지 및 누락 정보 자동 식별
-   추가 질문 및 심문 전략 추천
...
-   LMM (Large Multimodal Model): CCTV 등 영상자료 + 진술서 등 수사자료 복합 분석
-   LLM: 분석 결과 기반 수사 보고서 자동 작성
-   RAG(Vector DB): 법령 및 유사 사건 판례 기반 검색·분석 체계
-   Web-Backend 서버: API 및 서비스 관리
-   AI 서버: AI 모델 추론 및 데이터 분석 파이프라인 처리
...
-   수사 판단의 **객관성 및 일관성** 향상
-   조사관의 문서 작업 등 반복 업무 감소로 인한 **업무 효율 증대**
-   대량의 비정형 수사 자료에 대한 **신속한 분석** 지원
-   **설명 가능한 AI** 기반의 투명한 수사 행정 체계 구축
